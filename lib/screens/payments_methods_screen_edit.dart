...
class EditPaymentMethodScreen extends StatefulWidget {
  ...
  const EditPaymentMethodScreen({Key? key, required this.card})
    : super(key: key);
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (result != null && context.mounted) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(const SnackBar(content: Text('Error updating card')));
      }
    }
  }
                  ...
                  children: [
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        onTap: () => setState(() => _showBackOfCard = true),
                        onEditingComplete:
